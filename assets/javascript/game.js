...
var options = [
	{
		question: "Albert Einstein died?", 
		choice: ["1954", "1960", "1955", "1949"],
		answer: 2,
	 },
	 {
	 	question: "What kind of soda do you put in your whiskey?", 
		choice: ["Mountain Dew", "Sprite", "7-UP", "Coke"],
		answer: 0,
	 }, 
	 {
	 	question: "My favorite morning ritual?", 
		choice: ["Spice", "Caviar", "Coffee", "Rice variety" ],
		answer: 2,
	}, 
	{
		question: "What colour is sky?", 
		choice: ["Yellow", "Purple", "Red", "Blue" ],
		answer: 1,
	}, 
	{
	...
	var timeout = [
	{
		photo: "assets/images/timeout1.jpg"
	},
	{
		photo: "assets/images/timeout2.jpg"
	}];
...
$("#questionblock").html("<img src='assets/images/ThinkingMeme.jpg' id='onloadimg'>");
